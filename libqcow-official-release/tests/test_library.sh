...
LIBRARY_TESTS="cluster_block cluster_table deflate error file_header io_handle notify";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./qcow_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libqcow");
